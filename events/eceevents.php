...
<li class="bran" onclick="showlist('eceevents')"  style="background:#0080C0;color:white;">ECE</li>
...
<li class="bran" onclick="showlist('pucevents')">ENGG 1</li>
		...
		<div class=" demo-1">
			<center><h4><strong><h1 style="font-family:algerian;text-align: center;font-weight:bold;color:#0080C0;font-size:23px;"> 	ELECTRONIC AND COMMUNICATION EVENTS</h1>
        
			
			<ul class="grid cs-style-6" id="ee">
				<?php
				$eve = mysql_query("select * from `events` where  `category` = 'ECE'");
