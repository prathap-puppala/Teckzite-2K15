...
<li class="bran" onclick="showlist('open2allevents')"  style="background:#0080C0;color:white;">OPEN2ALL</li>
<li class="bran" onclick="showlist('pucevents')">PUC</li>
<li class="bran" onclick="showlist('pucevents')">ENGG 1</li>
</ul>
		<div class=" demo-1">
			<center><h4><strong><h1 style="font-family:algerian;text-align: center;font-weight:bold;color:#0080C0;font-size:23px;"> 	OPEN TO ALL EVENTS</h1>
        
			
			<ul class="grid cs-style-5" id="ee">
				<?php
				$eve = mysql_query("select * from `events` where  `category` = 'OPEN2ALL'");
