...
<li class="bran" onclick="showlist('pucevents')" style="background:#0080C0;color:white;">PUC</li>
<li class="bran" onclick="showlist('pucevents')" style="background:#0080C0;color:white;">ENGG 1</li>
</ul>
		<div class=" demo-3">
			<center><h4><strong><h1 style="font-family:algerian;text-align: center;font-weight:bold;color:#0080C0;font-size:23px;"> 	PUC && E1 EVENTS</h1>
        
			
			<ul class="grid cs-style-1" id="ee">
				<?php
				$eve = mysql_query("select * from `events` where  `category` = 'PUC'");
