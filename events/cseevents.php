...
<li class="bran" onclick="showlist('cseevents')" style="background:#0080C0;color:white;">CSE </li>
...
<li class="bran" onclick="showlist('pucevents')">ENGG 1</li>
		...
		<div class=" demo-1">
		<center><h4><strong><h1 style="font-family:algerian;text-align: center;font-weight:bold;color:#0080C0;font-size:23px;"> 	COMPUTER SCIENCE AND ENGINEERING EVENTS</h1>
               </strong></h4></center>
			
			<ul class="grid cs-style-3" id="ee">
				<?php
				$eve = mysql_query("select * from `events` where  `category` = 'CSE'");
