...
<li class="bran" onclick="showlist('chemevents')" style="background:#0080C0;color:white;">CHEMICAL</li>
...
<li class="bran" onclick="showlist('pucevents')">ENGG 1</li>
		...
		<div class=" demo-1">
		<center>
    		<center><h4><strong><h1 style="font-family:algerian;text-align: center;font-weight:bold;color:#0080C0;font-size:23px;"> CHEMICAL ENGINEERING EVENTS</h1>
        
			<ul class="grid cs-style-2" id="ee">
				<?php
				$eve = mysql_query("select * from `events` where  `category` = 'CHEM'");
