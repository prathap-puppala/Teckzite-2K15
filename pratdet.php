    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="">Welcome To Teckzite 2K15</a>
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li>
                <a href="home.php">Teckzite ID List</a>
              </li>
...
<table id="customers" style='width:60%;margin-left:20%;'>
  <tr>
    ...
    <th style='width:10%;'>Teckzite ID</th>
<th style='width:20%;' >Full Name</th>
<th style='width:20%;'>Studying</th>
...
?>
  <tr >
	      <td><?php echo $sno;?></td>
    <td><?php echo $data_f['stuid'];?></td>
    <td><?php echo $data_f['tzid'];?></td>
<td><?php echo "".$data_f['firstname']." ".$data_f['lastname']."";?></td>

<td><?php echo "".$data_f['batch']." - ".$data_f['branch']." - ".$data_f['class']."";?></td>
  <td><?php if($data_f['gender']=="M"){echo $data_f['phno'];}?></td>
