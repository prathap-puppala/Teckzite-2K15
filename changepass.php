...
<div  class="form" id="getziteidform">
    		<form id="contactform"> 
    		<center><h4><?php echo $_SESSION['tzid']." CHANGE PASSWORD";?></h4></center>
    			
    			 <p class="contact"><label for="passwd">Old Password</label></p> 
            <input id="tzfold" name="phone" placeholder="Old Password" required type="password"> <br>
            
            
            <p class="contact"><label for="passwd">New Password</label></p> 
            <input id="tzfnew" placeholder="New Password" required type="password"> <br>
              
                 <p class="contact"><label for="passwd">Confirm Password</label></p> 
            <input id="tzfcnfrm" placeholder="New Password" required type="password"> <br>
              
        
        <center> <a class="buttom" onclick="changepass()">Change</a> </center>
        <br>	 
   </form> 
</div>      
<br>
