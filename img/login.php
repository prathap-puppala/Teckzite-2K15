...
<table width="100%" style="margin-left:10%;">
	...
	<tr><td style="padding-top:20px;padding-left:-30px;"><center><span id="status" style="display:none;min-width:70%;"></span></center></td><td></td></tr>
	<tr>
...
<center><h4 style="font-weight:bold;"><b>TECKZITE2K15 REGISTRATION</h4></center><br>
  ...
  <br>
            ...
            <input id="email" placeholder="Email Address"  value="sd" required type="hidden"> <br>
...
<center><h4 style="font-weight:bold;"><b>FORGOT PASSWORD</h4></center><br>
    		<form id="contactform"> 
    			...
    			<input id="tzfuid"  placeholder="University ID" required  type="text"> 
...
?>
 ...
 <div style="position:fixed;top:40%;right:2%;font-weight:bold;color:red;"><a href="instructions.jpg" target="_blank"><img src='img/instructions.png' height="120px"></a></div> 
 <br>
</body>
</html>
